...
pub fn Button(class: &'static str,children: Children) -> impl IntoView {
    view!{
        <div class="relative group m-3 w-fit inline-block">
            ...
            <button class={format!("relative p-6 bg-2023-void-2 hover:bg-2023-void-2 btn btn-lg text-white ring-1 ring-2023-manga-3 rounded-2xl leading-none hover:text-shadow hover:shadow-[2px_5px_50px_-25px_rgba(46,194,126,1)] {}", class)}>
                {children()}
            </button>
        </div>
    }
